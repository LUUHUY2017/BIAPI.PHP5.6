...
class CreateSitesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sites', function(Blueprint $table){
            ...
            $table->string('site_code', 20)->nullable(false);
            $table->string('site_shortname', 50)->nullable(false);
            $table->string('site_name', 150)->nullable(false);
            $table->string('site_description', 250);
        });
    }
