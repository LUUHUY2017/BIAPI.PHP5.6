...
class SendMailMonthly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'SendMailMonthly';
     ...
     * @var string
     */
    protected $description = 'Send mail of report monthly';
    ...
    public function handle()
    {
        ...
        $response = $client->request('POST', 'api/fba_send_email_monthly',$arr);
        $response1 = $client->request('POST', 'api/poc_send_email_monthly',$arr);
        $response2 = $client->request('POST', 'api/age_send_email_monthly',$arr);
        $response3 = $client->request('POST', 'api/hqhd_send_email_monthly',$arr);
    }
}
