...
class TerminalExportController extends Controller
{
    ...
    public function sp_poc_gender_metric_analytic_export_excel(Request $request)
    {
        try {
            ...
            $value_header =  $this->get_value_header_gender_age($start_date, $end_date, $start_hour, $end_hour, $org_name);
    ...
    public function sp_poc_gender_metrics_comparison_export_excel(Request $request)
    {
        try {
            $request_user = $request->user();
            $user_id = $request_user != null ?  $request_user->id : null;
    ...
    public function sp_poc_gender_age_by_day_export_excel(Request $request)
    {
        try {
            $request_user = $request->user();
            $user_id = $request_user != null ?  $request_user->id : null;
