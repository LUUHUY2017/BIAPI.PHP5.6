...
class CreatePocDataInOutAdultChildrenTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('poc_data_in_out_adult_children', function (Blueprint $table) {
            $table->charset = 'utf8';
    ...
    {
        Schema::dropIfExists('poc_data_in_out_adult_children');
    }
}
