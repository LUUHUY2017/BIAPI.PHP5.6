...
class CreateOrganizationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('organizations', function(Blueprint $table){
            ...
            $table->string('organization_code', 150)->unique();
            $table->string('organization_shortname', 150)->unique();
            $table->string('organization_name', 150)->unique();
            $table->string('organization_description', 250)->nullable(true);
        });
    }
